...
import com.hcl.one2one.bidirectional.model.Address;
import com.hcl.one2one.bidirectional.model.User;
...
Navigation	One side only	Both sides
mappedBy used?	❌ No	✅ Yes (on inverse side)
Foreign key location	On owning side	On owning side
Complexity	Simpler	Slightly more complex
Use case	One-way access needed	Two-way access needed
 */
public class GetAll 
{
    ...
    // Open session
            ...
            try {
             ...
             List<User> uList=query1.list();
             System.out.println(uList);
             
             Query<Address> query2=session.createQuery("from Address",Address.class);
             List<Address> uList1=query2.list();
