...
import com.hcl.one2many.unidirectional.model.Department;
import com.hcl.one2many.unidirectional.model.Employee;
...
public class App 
{
    public static void main( String[] args )
    {
       ...
       employeeList.add(new Employee("Kishan","9565301270","Varanasi"));
       employeeList.add(new Employee("Mukesh","9565301270","Varanasi"));
       employeeList.add(new Employee("Santosh","24565301270","Greater Noida"));
       Department department1=new Department("IT","Brijesh Nishad",employeeList);

       List<Employee> employeeList2=new ArrayList<>(); 
       employeeList.add(new Employee("Rohan","95601270","Noida"));
       employeeList.add(new Employee("Sohan","01270","Varanasi"));
       employeeList.add(new Employee("Shivam","5301270","Noida"));
       Department department2=new Department("Sales","Shivam",employeeList2);
