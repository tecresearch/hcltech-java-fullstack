...
import com.hcl.many2one.unidirectional.model.Department;
import com.hcl.many2one.unidirectional.model.Employee;
...
public class App 
{
    public static void main( String[] args )
    {
       ...
       transaction.begin();
       Department department1=new Department("IT","Brijesh");
       Department department2=new Department("Sales","Saurah");
       Department department3=new Department("Marketing","suraj");
       session.persist(new Employee("Brijesh Nishad","34523","noida",department1));
       session.persist(new Employee("Rohit Nishad","3452f","noida",department2));
       session.persist(new Employee("Soha Nishad","344523","noida",department3));
       session.persist(new Employee("Shiv Nishad","3423523","noida",department1));
       session.persist(new Employee("Bk Nishad","3452343","noida",department2));
       session.persist(new Employee("Sk Nishad","345234","noida",department3));
       transaction.commit();
