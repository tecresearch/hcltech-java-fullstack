...
import com.hcl.many2many.unidirectional.model.Course;
import com.hcl.many2many.unidirectional.model.Student;
...
public class App 
{
    public static void main( String[] args )
    {
       ...
       courses.add(new Course("The Hindu"));
       courses.add(new Course("The Ramayan"));
       courses.add(new Course("The Gita"));
       courses.add(new Course("The Mahabhar"));
       courses.add(new Course("The OK"));
       courses.add(new Course("The GOd"));
       
       List<Course> courses1=new ArrayList<>();
       courses.add(new Course(" Hindu"));
       courses.add(new Course(" Ramayan"));
       courses.add(new Course(" Gita"));
       courses.add(new Course(" Mahabhar"));
       courses.add(new Course(" OK"));
       courses.add(new Course(" GOd"));
       
       Student s1=new Student(courses);
       Student s2=new Student(courses1);
